...
(fact "POST /children makes children"
  (request-authenticated main-routes :post "/children" token nil {:birthday "2010-04-21"}) => (contains [200 (contains {"type" "child" "birthday" "2010-04-21"})])
...
(fact "GET /children/:id retrieves an existing child node"
  ...
  (against-background (around :facts (let [id ((last (request main-routes :post "/users" nil {:email "test6@verify.me" :password "test" :latitude 30 :longitude 25})) "id")
                                           ...
                                           child-id ((last (request-authenticated main-routes :post "/children" token nil {:birthday "2010-04-21"})) "id")] ?form))))
...
(fact "PUT /children/:id/friends/:friend-id makes friends for children"
  ...
  (against-background (around :facts (let [id ((last (request main-routes :post "/users" nil {:email "test7@verify.me" :password "test" :latitude 30 :longitude 25})) "id")
                                           ...
                                           child-id ((last (request-authenticated main-routes :post "/children" token nil {:birthday "2010-03-21"})) "id")
                                           friend-id ((last (request-authenticated main-routes :post "/children" token nil {:birthday "2010-04-21"})) "id")] ?form))))
